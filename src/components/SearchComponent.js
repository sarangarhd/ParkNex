...
const handleSearch = text =>{
    const dataS = filter(parkingData, userSearch =>{
            ...
            renderItem={({ item }) => (
              <TouchableOpacity 
                       onPress = {() =>{
                            ...
                            Keyboard.dismiss
                            navigation.navigate("SearchResultScreen",{item:item.ParkName})
                            setModalVisible(false)
                            setTextInputFossued(true)
                                }} >
                    <View style={styles.view2}>
                        <Text style={{color:colors.grey5, fontSize:15 }}>{item.ParkName}</Text>
                    </View>
              </TouchableOpacity>
                )}
